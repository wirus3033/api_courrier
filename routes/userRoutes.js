...
router.post('/register', authenticateToken, async (req, res) => {
    const { pseudo, passe, nom, prenom, matricule, direction, fonction, acces } = req.body;
    ...
    try {
        ...
        const query = `
            ...
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        `;
        await db.promise().query(query, [pseudo, hashedPassword, nom, prenom, matricule, direction, fonction, acces]);
